class CarSystem {
  ...
  CarSystem(int populationSize, float [] LowerWeight, float [] HigherWeight, float [] LowerBias, float [] HigherBias) {
    for (int i=0; i<populationSize; i++) { 
      CarController controller = new CarController(LowerWeight, HigherWeight, LowerBias, HigherBias);
